...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/views/styles.scss":
/*!**************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/sass-loader/lib/loader.js!./src/views/styles.scss ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./src/commands/rearrangeArtboards.js":
/*!********************************************!*\
  !*** ./src/commands/rearrangeArtboards.js ***!
  \********************************************/
...
/* harmony import */ var _helpers_storage_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/storage.js */ "./src/helpers/storage.js");
...
/* harmony import */ var _lib_dialog__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../lib/dialog */ "./src/lib/dialog.js");
/* harmony import */ var _lib_dialog__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_lib_dialog__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _helpers_debug_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../helpers/debug.js */ "./src/helpers/debug.js");
/*
...
function metaArtboards(nodes) {
  const artB = Object(_helpers_utils_js__WEBPACK_IMPORTED_MODULE_2__["artboards"])(nodes);
...
function getOrigin(artboards) {
  const minX = artboards.reduce((prev, current) => prev.left < current.left ? prev : current, 1)``;

  const minY = artboards.reduce((prev, current) => prev.top < current.top ? prev : current, 1);
  return {
    x: minX.left,
    y: minY.top
  };
 ...
 */
/* harmony default export */ __webpack_exports__["default"] = (async function rearrangeArtboards(selection, documentRoot) {
  ...
  if (allArtboards.length <= 0) {
    _lib_dialog__WEBPACK_IMPORTED_MODULE_3___default.a.alert("Rearrange Artboards into Grid", "You don't have artboard(s) in your document.");
    return;
  }

  // Settings
  const spaceX = await _helpers_storage_js__WEBPACK_IMPORTED_MODULE_1__["default"].get("spaceX", _helpers_Constants__WEBPACK_IMPORTED_MODULE_0__["DEFAULT_SPACEX"]);
  const spaceY = await _helpers_storage_js__WEBPACK_IMPORTED_MODULE_1__["default"].get("spaceY", _helpers_Constants__WEBPACK_IMPORTED_MODULE_0__["DEFAULT_SPACEY"]);
  ...
  allArtboards.filter(ab => !rowStarterArtboards.includes(ab)).forEach(ab => {
    rowStarterArtboards.forEach(abStarter => {
      abStarter._tmpDistance = Math.abs((abStarter.top + abStarter.bottom) / 2 - (ab.top + ab.bottom) / 2);
    });

    const curStarterAb = rowStarterArtboards.reduce((prev, current) => prev._tmpDistance < current._tmpDistance ? prev : current);
    rows[curStarterAb.row].push(ab);

    // update row height
    rowHeights[curStarterAb.row] = Math.max(rowHeights[curStarterAb.row], ab.bottom - ab.top);
  });
...
/***/ "./src/commands/sortArtboards.js":
/*!***************************************!*\
  !*** ./src/commands/sortArtboards.js ***!
  \***************************************/
/*! exports provided: sortAZ, sortZA */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortAZ", function() { return sortAZ; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortZA", function() { return sortZA; });
/* harmony import */ var commands__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! commands */ "commands");
/* harmony import */ var commands__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(commands__WEBPACK_IMPORTED_MODULE_0__);
...
function sort(selection, sortedArboards) {
  ...
  if (sortedArboards.length <= 0) {
    _lib_dialog__WEBPACK_IMPORTED_MODULE_3___default.a.alert("Sort Artboards", "You don't have artboard(s) in your document.");
    return;
  }

  sortedArboards.forEach(node => {
    selection.items = node;
    commands__WEBPACK_IMPORTED_MODULE_0___default.a.bringToFront();
  });
  selection.items = [];
}
...
function sortAZ(selection, documentRoot) {
  // @ts-ignore
  const sortedArboards = array_sort__WEBPACK_IMPORTED_MODULE_1___default()(Object(_helpers_utils_js__WEBPACK_IMPORTED_MODULE_2__["artboards"])(documentRoot.children), "name", {
    reverse: true
  });
...
/* harmony import */ var _lib_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../lib/dialog */ "./src/lib/dialog.js");
/* harmony import */ var _lib_dialog__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_lib_dialog__WEBPACK_IMPORTED_MODULE_2__);




/* harmony default export */ __webpack_exports__["default"] = (function (selection, documentRoot) {
  if (selection.items.length <= 0) {
    _lib_dialog__WEBPACK_IMPORTED_MODULE_2___default.a.alert("Create Artboard Around Selection", "You need to select at least one layer.");
    return;
  } else if (selection.hasArtboards) {
    _lib_dialog__WEBPACK_IMPORTED_MODULE_2___default.a.alert("Create Artboard Around Selection", "Artbord can't be created around another artboard. Please de-select artboard.");
    return;
  }
  ...
  commands__WEBPACK_IMPORTED_MODULE_1___default.a.ungroup();
  ...
  artboard.fill = new scenegraph__WEBPACK_IMPORTED_MODULE_0__["Color"]("#ffffff");
...
/*!**********************************!*\
  !*** ./src/helpers/Constants.js ***!
  \**********************************/
/*! exports provided: DEFAULT_SPACEX, DEFAULT_SPACEY */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_SPACEX", function() { return DEFAULT_SPACEX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_SPACEY", function() { return DEFAULT_SPACEY; });
const DEFAULT_SPACEX = "100";
const DEFAULT_SPACEY = "200";
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return debugHelper; });
/*
...
/* harmony import */ var _debug_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./debug.js */ "./src/helpers/debug.js");
/*
 * Copyright (c) 2018. by Pablo Klaschka
 */
...
const fs = uxp__WEBPACK_IMPORTED_MODULE_0__["storage"].localFileSystem;
...
class storageHelper {
  ...
  static async init() {
    ...
    try {
      ...
      _debug_js__WEBPACK_IMPORTED_MODULE_1__["default"].log("Creating file");
      const file = await dataFolder.createEntry("data.json", {
        type: uxp__WEBPACK_IMPORTED_MODULE_0__["storage"].types.file,
        overwrite: true
      });
      if (file.isFile) {
  ...
  static async get(key, defaultValue) {
    ...
    let object = JSON.parse((await dataFile.read({ format: uxp__WEBPACK_IMPORTED_MODULE_0__["storage"].formats.utf8 })).toString());
  ...
  static async set(key, value) {
    ...
    return await dataFile.write(JSON.stringify(object), {
      append: false,
      format: uxp__WEBPACK_IMPORTED_MODULE_0__["storage"].formats.utf8
    });
  }
...
async function confirm(title, msg, buttons = ["Cancel", "OK"]) {
  return createDialog({
    title,
    msgs: [msg],
    buttons: [{ label: buttons[0], type: "reset", variant: "primary" }, { label: buttons[1], type: "submit", variant: "cta" }]
  });
}
...
async function warning(title, msg, buttons = ["Cancel", "OK"]) {
  return createDialog({
    title,
    msgs: [msg],
    buttons: [{ label: buttons[0], type: "submit", variant: "primary" }, { label: buttons[1], type: "button", variant: "warning" }]
  });
}
...
const reactShim = __webpack_require__(/*! ./helpers/react-shim */ "./src/helpers/react-shim.js");
const React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const ReactDOM = __webpack_require__(/*! react-dom */ "./node_modules/react-dom/index.js");
const { DEFAULT_SPACEX, DEFAULT_SPACEY } = __webpack_require__(/*! ./helpers/Constants */ "./src/helpers/Constants.js");
const wrapSelection = __webpack_require__(/*! ./commands/wrapSelection */ "./src/commands/wrapSelection.js").default;
const sortAZ = __webpack_require__(/*! ./commands/sortArtboards */ "./src/commands/sortArtboards.js").sortAZ;
const sortZA = __webpack_require__(/*! ./commands/sortArtboards */ "./src/commands/sortArtboards.js").sortZA;
const rearrangeArtboards = __webpack_require__(/*! ./commands/rearrangeArtboards */ "./src/commands/rearrangeArtboards.js").default;
const Settings = __webpack_require__(/*! ./views/settings.jsx */ "./src/views/settings.jsx").default;
const storageHelper = __webpack_require__(/*! ../src/helpers/storage */ "./src/helpers/storage.js").default;
...
function showSettings() {
  if (dialog == null) {
    ...
    ReactDOM.render(React.createElement(Settings, { dialog: dialog }), dialog);
  }
...
/* harmony import */ var is_number__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! is-number */ "./node_modules/is-number/index.js");
/* harmony import */ var is_number__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(is_number__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _helpers_storage_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/storage.js */ "./src/helpers/storage.js");
/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./styles.scss */ "./src/views/styles.scss");
/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_styles_scss__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _helpers_debug_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers/debug.js */ "./src/helpers/debug.js");
...
class Settings extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  async componentDidMount() {
    const spX = await _helpers_storage_js__WEBPACK_IMPORTED_MODULE_3__["default"].get("spaceX", _helpers_Constants__WEBPACK_IMPORTED_MODULE_2__["DEFAULT_SPACEX"]);
    const spY = await _helpers_storage_js__WEBPACK_IMPORTED_MODULE_3__["default"].get("spaceY", _helpers_Constants__WEBPACK_IMPORTED_MODULE_2__["DEFAULT_SPACEY"]);
    this.setState({ spaceX: spX, spaceY: spY });
    document.addEventListener("keydown", this.enterFunction, false);
  }

  onInputChange(e) {
    if (!is_number__WEBPACK_IMPORTED_MODULE_1___default()(e.target.value) || e.target.value < 0) {
  ...
  async onSubmit(e) {
    e.preventDefault();
    await _helpers_storage_js__WEBPACK_IMPORTED_MODULE_3__["default"].set("spaceX", String(this.state.spaceX));
    await _helpers_storage_js__WEBPACK_IMPORTED_MODULE_3__["default"].set("spaceY", String(this.state.spaceY));
  ...
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      ...
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          "div",
          { className: `errorMessage ${this.state.spaceXError}` },
      ...
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          "button",
          { type: "submit", "uxp-variant": "secondary", onClick: this.onCancel },
          "Cancel"
        ),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          "button",
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!../../node_modules/sass-loader/lib/loader.js!./styles.scss */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/views/styles.scss");
