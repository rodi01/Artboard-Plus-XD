...
/* harmony import */ var _helpers_debug_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/debug.js */ "./src/helpers/debug.js");
/*
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../lib/dialogs.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ __webpack_exports__["default"] = (function (selection, documentRoot) {
  if (selection.items.length <= 0) {
    !(function webpackMissingModule() { var e = new Error("Cannot find module '../lib/dialogs.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).alert("Wrap Around Selection 🤘", "You need to select at least one layer.");
    return;
  } else if (selection.hasArtboards) {
    !(function webpackMissingModule() { var e = new Error("Cannot find module '../lib/dialogs.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).alert("Wrap Around Selection 🤘", "Artbord can't be created around another artboard. Please de-select artboard.");
    return;
  }
